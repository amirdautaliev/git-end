        ...
        <form action="avatar_upload" method="POST" enctype="multipart/form-data">
            <div class="row">
                ...
                <?php
							...
							<?php echo $_SESSION['upload_image'];
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
											...
											echo '<img src="'.  '/'.$image['image'] .'" alt="" class="img-responsive" width="200">';
											}
											else {
												echo '<img src="'.  '/'.'no_image/no.jpg' .'" alt="" class="img-responsive" width="200">';
											}
											?>
                                </div>
