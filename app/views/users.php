...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <?php if(isset($_SESSION['no_author'])):?>
            <div class="alert alert-danger">
            <?php echo $_SESSION['no_author'];
                    unset($_SESSION['no_author']);
                ?>
                <?php endif;?>  
                <?php if(isset($_SESSION['author_admin'])):?>
            <div class="alert alert-danger">
            <?php echo $_SESSION['author_admin'];
                    unset($_SESSION['author_admin']);
                ?>
                <?php endif;?>  
            </div>
            <div class="subheader">
                            ...
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    echo  '<i class="fal fa-angle-down d-inline-block ml-1 fs-md"></i>';
                                         ...
                                         elseif($user['id']==$_SESSION['auth_user_id']) 
                                        {
